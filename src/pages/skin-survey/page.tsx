  ...
  const handleQuizComplete = async (data: any) => {
    ...
    try {
      ...
      const payload = {
        ...
        // Onboarding v2 fields (top-level columns)
        skincare_experience: data.skincareExperience || null,
        monthly_spend: data.monthlySpend || null,
        spend_satisfaction: data.spendSatisfaction || null,
        spend_pain_points: data.spendPainPoints || [],
        product_count: data.productCount || null,
        routine_goal: data.routineGoal || null,
        purchase_channels: data.purchaseChannel || [],
        retailer_satisfaction: data.retailerSatisfaction || null,
        retailer_pain_points: data.retailerPainPoints || [],
        frustrations: data.frustrations || [],
        frustration_free_response: data.frustrationFreeResponse || null,
        referral_source: data.referralSource || null,
        referral_source_other: data.referralSourceOther || null,
        skin_goal: data.skinGoal || null,
        search_use_climate: data.searchFilters?.useClimate ?? true,
        search_use_preferences: data.searchFilters?.usePreferences ?? true,
        search_use_budget: data.searchFilters?.useBudget ?? true,
        prioritized_goals: data.prioritizedGoals || [],
