...
- **Name**: Ethan Jones
- **Age**: 18 years old
- **Background**: Young African American male, currently in high school, solopreneur
- **Role**: Founder & CEO — sole developer, designer, product strategist, and operator
- **Notable**: Built the entire MVP solo while in high school, demonstrating exceptional technical ability and entrepreneurial drive. Self-taught full-stack developer with a production-grade tech stack.
- **Narrative angle**: Gen Z founder who experienced the skincare confusion firsthand and built the solution himself — a compelling underdog/builder story for press, content, and investor narratives.

### Credibility & Proof Points
- **Revenue milestones**: Pre-revenue (pre-launch)
- **Case studies / results delivered**: N/A
- **Years of relevant experience**: Self-taught developer; built full production MVP solo
- **Notable clients, platforms, or associations**: N/A
...
- **Objections**:
  ...
  3. "Is the subscription worth it when I can get free advice on Reddit/YouTube?"
- **Where they hang out online**: TikTok, Instagram, Reddit (r/SkincareAddiction, r/AsianBeauty), YouTube, skincare-focused Discord servers, Facebook groups
- **Content they consume**: Skincare YouTube (Hyram, Dr. Dray, James Welsh), beauty TikTok, Lab Muffin Beauty Science, The Ordinary community content, wellness podcasts
- **Decision-making style**: Research-heavy, community-influenced, data-informed, intentional. Patch-testers. Price-sensitive but quality-driven.

### Customer Insights
- Curious but overwhelmed
- Motivated by self-improvement
- Skeptical of hype and misinformation
- Hungry for clarity, transparency, and personalization
- Open to tech that simplifies their journey
- Seeking control over their routine and results
...
- **Current solution they use**: Etsy, Instagram DMs, Shopify standalone stores, word-of-mouth
- **Why current solution fails them**: No targeted audience, high fees, no trust infrastructure, no analytics tied to skincare outcomes
- **Buying triggers**: Looking for distribution channels, launching new products, wanting data on what consumers need
- **Objections**:
  1. "Will there actually be enough buyers on this platform?"
  2. "What are the fees vs. Etsy/Shopify?"
...
- **Revenue model**: Hybrid (Freemium subscription + Affiliate commissions + Marketplace fees + E-commerce + Data licensing)
...
- **Brand personality**: Intelligent, trustworthy, empowering, approachable, inclusive
...
- **Brand values**:
  ...
  3. **Inclusivity** — Solutions for all skin types, tones, and budgets
...
| Document | Location / Link | Description |
|---|---|---|
...
> How sub-agents should use this document:
