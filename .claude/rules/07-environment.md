---
scope: "Location, UV, climate, season, texture inference, consent, jargon-free rules, knowledge base"
authority: primary
last_synced: "2026-03-14"
related: ["04-state-management.md", "06-ai-product-voice.md"]
---

# Environment & Location Pipeline
...
Copy templates → `ai-governance/CLAUDE_PRODUCT.md` Section 8.
...
For user-facing reviewer evidence framing → `ai-governance/CLAUDE_PRODUCT.md` Section 9.
