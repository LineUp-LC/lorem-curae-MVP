...
> Trigger: Read this file when writing new components, editing existing code, naming files/functions/variables, or formatting code.
...
- State persistence: localStorage for guest, Supabase for authenticated
