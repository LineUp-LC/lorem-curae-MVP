---
scope: "React patterns, Tailwind, design tokens, typography, motion, component tiers, accessibility, copywriting"
authority: primary
last_synced: "2026-03-14"
related: ["02-code-standards.md", "05-ai-pipeline.md"]
---
...
For user-facing emotional intelligence templates, diagnostic-adjacent safety framing, and price-conscious UX copy → `ai-governance/CLAUDE_PRODUCT.md` Sections 3, 5, 11.
